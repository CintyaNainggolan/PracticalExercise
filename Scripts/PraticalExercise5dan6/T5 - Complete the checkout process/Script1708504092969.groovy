...
WebUI.click(findTestObject('Object Repository/saucedemo5/Page_Swag Labs/button_Add to cart'))

WebUI.click(findTestObject('Object Repository/saucedemo5/Page_Swag Labs/a_1'))
...
WebUI.click(findTestObject('Object Repository/saucedemo5/Page_Swag Labs/button_Checkout'))
...
WebUI.click(findTestObject('Object Repository/saucedemo5/Page_Swag Labs/button_Finish'))

String actual_result4 = WebUI.getText(findTestObject('Object Repository/saucedemo/Page_Swag Labs/span_Checkout Complete'))

WebUI.verifyMatch(actual_result4, 'Checkout: Complete!', false)

System.out.println(WebUI.verifyElementPresent(findTestObject('Object Repository/saucedemo/Page_Swag Labs/span_Checkout Complete'), 5))

WebUI.click(findTestObject('Object Repository/saucedemo5/Page_Swag Labs/button_Back Home'))
