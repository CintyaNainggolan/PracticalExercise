...
String actual_result2 = WebUI.getText(findTestObject('Object Repository/saucedemo/Page_Swag Labs/button_Back to products'))

WebUI.verifyMatch(actual_result2, 'Back to products', false)

System.out.println(WebUI.verifyElementPresent(findTestObject('Object Repository/saucedemo/Page_Swag Labs/button_Back to products'), 5))
